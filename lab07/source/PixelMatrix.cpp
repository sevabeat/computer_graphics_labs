...
//void PixelMatrix::setPixel(int h, int w, COLOR color) {
//    for(int i = 0; i < this->pixelBytes; i++){
//        this->matrix[this->getPosition(h, w) + i] = (uchar)(color[i] * 255);
//    }
//}
//
//COLOR PixelMatrix::getPixel(int w, int h) {
//    COLOR color(3);
//    for(int i = 0; i < this->pixelBytes; i++){
//        color[i] = this->matrix[this->getPosition(h, w) + i] / 255.0;
//    }
//    return color;
//}
